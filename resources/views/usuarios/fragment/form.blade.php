	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-6">
				...
				<div class="input-group">
					...
					de Ciudadanía', 'TI' => 'Tarjeta de Identidad', 'RC'=>'Registro
					Civil', 'CN'=>'Certificado de Nacido Vivo'], null,
					...
					Permanencia', 'CD' => 'Carné Diplomático', 'PA' => 'Pasaporte',
					'CE' => 'Cedula de Extranjería', 'CC' => 'Cedula de Ciudadanía',
		...
		<div class="row">
			...
			<div class="col-lg-6">
				...
				$errors->first('SEXO',' <span class="alert text-danger pull-right"><button
